...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("daystarapp", "0063_alter_babyfee_departure_time_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.DecimalField(
                decimal_places=2, max_digits=10, verbose_name="Daily Consumption"
            ),
        ),
        migrations.AlterField(
            model_name="supply",
        ...
        migrations.AlterField(
            ...
            name="qty_left",
            field=models.DecimalField(
                decimal_places=2, max_digits=10, verbose_name="Quantity Left"
            ),
        ),
        migrations.AlterField(
            model_name="supply",
            name="qty_on_hand",
            field=models.DecimalField(
                decimal_places=2, max_digits=10, verbose_name="Quantity In Stock"
            ),
        ),
        migrations.AlterField(
            model_name="supply",
            name="qty_stocked",
            field=models.DecimalField(
                decimal_places=2, max_digits=10, verbose_name="Quantity Stocked"
            ),
        ),
    ]
